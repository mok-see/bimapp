...
def get_space_info():
    return session.ifc_file.by_type("IfcSpace")
...
def main():      
    ...
    #### Based on Sigma Dimensions (TM)
    
    Follow us [on Youtube](https://www.youtube.com/channel/UC9bPwuJZUD6ooKqzwdq9M9Q?sub_confirmation=1)
    
    --------------
    License: [GPL-2.0 license](https://github.com/mok-see/bimapp/blob/main/LICENSE)
